...
import { LifeBuoy, Wrench, LogOut, UserCircle, Loader2, AlertCircle, History, Settings } from 'lucide-react'; // Added Settings for Profile
...
const Header = () => {
  ...
  const canViewMyRequests = role === 'user' || (user && !role);
  const isGeneralUser = role === 'user' || (user && !role); // For profile link visibility
    ...
    <header className="bg-primary text-primary-foreground shadow-lg sticky top-0 z-50">
      <div className="container mx-auto flex items-center justify-between h-16 px-4 md:px-6">
        ...
        <nav className="flex items-center gap-3">
          {(role === 'admin' || role === 'mechanic' || role === 'customer_relations') && (
          ...
          {loading ? (
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent className="w-56" align="end" forceMount>
                ...
                {(isGeneralUser || canViewMyRequests) && <DropdownMenuSeparator />}
